                ...
                <View style={styles.optionsContainer}>
                    <TouchableOpacity
                        ...
                        <View style={styles.square}>
                            <Ionicons name="mail-outline" size={30} color="#54408C" style={{ left: '23%', }} />
                        </View>
                        <Text style={{ color: 'black', fontSize: 20, right: '30%', top: '5%', fontWeight: '600' }}>Email</Text>
                    ...
                    <TouchableOpacity
                        ...
                        <View style={styles.square}>
                            <Ionicons name="call-outline" size={30} color="#54408C" style={{ left: '23%', }} />
                        </View>
                        <Text style={{ color: 'black', fontSize: 20, right: '30%', top: '5%', fontWeight: '600' }}>Phone</Text>
