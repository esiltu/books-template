...
const SignUp = () => {
    ...
    const handleSubmit = (values, { resetForm }) => {
        ...
        setTimeout(() => {
            ...
            if (values.name === "test" && values.email === 'test@test.com' && values.password === 'password') {
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: 'white' }}>
            ...
            <View style={{ top: '7.5%' }}>
                <Text style={{ color: 'black', fontWeight: 'bold', fontSize: 30, left: '7.5%' }}>Sign Up 😾</Text>
                <Text style={{ color: '#A6A6A6', fontWeight: '500', fontSize: 17, left: '7.5%', top: '20%' }}>Create account and choose favorite menu</Text>
            </View>
                ...
                >
                    {({ handleChange, handleBlur, handleSubmit, values, errors, touched, setFieldTouched }) => (
                        <>
                            ...
                            <Text style={{ fontSize: 17, fontWeight: '500', bottom: '5%', }}>Email</Text>
                            <TextInput
                                autoCapitalize="none"
                                placeholderTextColor="#B8B8B8"
                            ...
                            <Text style={{ fontSize: 17, fontWeight: '500', bottom: '11%' }}>Password</Text>
                            <TextInput
                                autoCapitalize="none"
                                placeholderTextColor="#B8B8B8"
                            ...
                            <TouchableOpacity
                                ...
                                activeOpacity={0.6}
                            >
                                <Text style={{ color: 'white', fontSize: 19, fontWeight: '600', textAlign: 'center', top: '30%', }}>Register</Text>
                            </TouchableOpacity>
                        </>
                    )}
                </Formik>
            ...
            <View style={{ top: '2.5%', }}>
                <TouchableOpacity style={{ backgroundColor: 'white', alignSelf: 'center', }} activeOpacity={0.6} onPress={goToLoginPage} >
                    <Text style={{ fontSize: 17, color: '#A6A6A6', fontWeight: '500' }}>Have an account? <Text style={{ color: '#54408C' }}>Sign In</Text></Text>
                </TouchableOpacity>
            </View>
        </SafeAreaView>
    )
