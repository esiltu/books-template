...
const SignIn = () => {
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: 'white' }}>
                ...
                >
                    {({ handleChange, handleBlur, handleSubmit, values, errors, touched, setFieldTouched }) => (
                        <>
                            ...
                            <Text style={{ fontSize: 17, fontWeight: '500', bottom: '7%' }}>Password</Text>
                            <TextInput
                                autoCapitalize="none"
                                placeholderTextColor="#B8B8B8"
                            ...
                            <TouchableOpacity style={{ backgroundColor: 'white', bottom: '28%', width: '30%', left: '0%', }} onPress={goToForgotPassword} activeOpacity={0.6}>
                                <Text style={{ color: '#54408C', fontSize: 16, width: '150%', fontWeight: '500' }}>Forgot Password?</Text>
                            </TouchableOpacity>
                            ...
                            >
                                <Text style={{ color: 'white', fontSize: 19, fontWeight: '600', textAlign: 'center', top: '25%', }}>Login</Text>
                            </TouchableOpacity>
                        </>
                    )}
                </Formik>
            ...
            <View>
                <Image source={require('../../assets/styling/Group.png')} style={{ width: '100%', height: '20%', alignSelf: 'center', top: '15%', }} />
            </View>
            {/* Other methods Social Loginss */}
            <View>
                <TouchableOpacity style={{ backgroundColor: 'white', height: '30%', bottom: '18%', }} onPress={() => console.log("pressed on google")}>
                    <Image source={require('../../assets/styling/logininwithgoogle.png')} style={{ height: '35%', alignSelf: 'center', width: '85%', }} />
                </TouchableOpacity>
                <TouchableOpacity style={{ backgroundColor: 'white', height: '30%', bottom: '35%', }} onPress={() => console.log("pressed on apple")}>
                    <Image source={require('../../assets/styling/logininwithapple.png')} style={{ height: '35%', alignSelf: 'center', width: '85%', }} />
                </TouchableOpacity>
            </View>
        </SafeAreaView>
    );
